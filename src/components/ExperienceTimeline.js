...
const ExperienceTimeline = ({ language }) => {
  ...
  const experiences = [
    ...
    },
    {
      ...
      description: language === 'fr'
        ? "Plus de 18 ans de développement de solutions systèmes, d'automatisation et d'outils de performance à travers 68 projets."
        : 'Over 18 years building systems software, automation, and performance tooling across 68 projects.',
